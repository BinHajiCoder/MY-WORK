			...
			<div class="app-container">
				...
				<div class="main-content"> 
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header"> View Licence Vehicle information  </div>
								<div class="card-body">
                                                                    
                                                                     <?php
                                                                     $id=$_SESSION['idReg'];
                                                                        $sql="SELECT * FROM vehicle_description v, licencevehicle l where
                                                                                     v.regNo=l.regNo and l.regNo=?";
									...
									<table id="basicExample" class="table table-bordered">
										...
										<tbody>
                                                                                     ...
                                                                                     <?php
                                                                                        ...
                                                                                        {
                                                                                            $lic= $print['licenNo'];
                                                                                            $seat= $print['setingCapacity'];
                                                                                            $typ= $print['typeVehicles'];
