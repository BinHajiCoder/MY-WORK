			...
			<div class="app-container">
				...
				<div class="main-content"> 
                                    ...
                                    <div class="row gutters">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                   <div class="row gutters">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" >
                                                            <div class="card">
                                                                <div class="card-header"> Select the registration vehicle no to upload the receipt</div>
                                                                <div class="card-body" style="background: #e3e7e7">
                                                                    
                                                                    <form action="phpHendler/paymentRequest.php" method="POST">
										...
										<div class="col-xl-4 col-lg col-md-4 col-sm-4 col-12">
                                                                                    <input type="submit" class="btn btn-success btn-rounded" name="btnSave" value="Requeast Reg">
                                                                                </div>
                                                                            </div>
                                                                    </form>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <label style="color: red"> If complete to register the vehicle discription, select the request Reg No to upload the receipt. if not register  the vehicle please register fist then view result. </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
