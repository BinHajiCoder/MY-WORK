			...
			<div class="app-container">
				...
				<div class="main-content"> 
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header"> View Refuse Information  </div>
								<div class="card-body">
                                                                    
                                                                     <?php
                                                                     $id=$_SESSION['idReg'];
                                                                        $sql="SELECT * FROM vehicle_description v, refuseapplication r where
                                                                                     v.regNo=r.regNo and r.regNo=?";
									...
									<table id="basicExample" class="table table-bordered">
										...
										<tbody>
                                                                                     ...
                                                                                     <?php
                                                                                        ...
                                                                                        {
                                                                                            $ref= $print['refuseApplicationcol'];
											...
											<tr>
												...
												<td><?php echo $ref ?></td>
                                                                                                <td><a href="MoreViewVehicleForm.php">
                                                                                                        <span class="badge badge-danger col-md-4 " style="font-size: 15px">Click to Back</span>
