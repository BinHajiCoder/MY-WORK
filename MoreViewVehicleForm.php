						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								...
								<div class="card-body">
                                                                     ...
                                                                     <?php
                                                                     $id=$_SESSION['idReg'];
                                                                        $sql="SELECT * FROM vehicle_description v,users u,drivers d where
                                                                                u.userName=v.userName and v.regNo=d.regNo and v.regNo=?";
									...
									<table id="basicExample" class="table table-bordered">
										...
										<tbody>
                                                                                     ...
                                                                                     <?php
                                                                                        ...
                                                                                        {
                                                                                            $full= $print['fullNames'];
                                                                                            $add= $print['address'];
                                                                                            $phone= $print['phoneDriver'];
                                                                                            $lice= $print['licencNoDriver'];
                                                                                            $issue= $print['issuDateLicence'];
                                                                                            $date= $print['dateExpiryLicence'];
                                                                                            $idReg= $print['regNo'];
											...
											<tr>
												...
												<td><?php echo $date ?></td>
                                                                                                <td><a href="phpHendler/updatePaymentStatus.php?updateID=<?php echo  $idReg ?>">
                                                                                                        <span class="badge badge-success col-md-12 " style="font-size: 15px">Reply Request</span>
