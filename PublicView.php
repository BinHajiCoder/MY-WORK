			...
			<div class="app-container">
				...
				<div class="main-content"> 
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header"> View Public information  </div>
								<div class="card-body">
                                                                    
                                                                     <?php
                                                                     $id=$_SESSION['idReg'];
                                                                        $sql="SELECT * FROM vehicle_description v, public_service p where
                                                                                     v.regNo=p.regNo and p.regNo=?";
